...
def transform():
    ...
    # Buat tabel fakta
    fact_customer = df[['Customer_ID', 'gender_id', 'income_id', 'region_id', 'Num_of_Children', 'Age']]
    fact_customer.columns = ['customer_id', 'gender_id', 'income_id', 'region_id', 'num_of_children', 'age']

    fact_behavior = df[['Customer_ID', 'Spending_Score', 'Credit_Score', 'shopping_frequency_id', 'marital_status_id']]
    fact_behavior.columns = ['customer_id', 'spending_score', 'credit_score', 'shopping_frequency_id', 'marital_status_id']

    fact_marketing = df[['Customer_ID', 'Target', 'employment_id', 'income_id', 'region_id']]
    fact_marketing.columns = ['customer_id', 'target_flag', 'employment_id', 'income_id', 'region_id']
...
with DAG(
    dag_id='customer_star_schema_etl',
